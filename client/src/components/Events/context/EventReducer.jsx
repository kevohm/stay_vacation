...
export const reducer = (state, action) => {
  switch (action.type) {
    case actions.GET_EVENTS: {
      ...
      return {
        ...state,
        events: { ...state.events, data, pages, currentPage, loading: false },
      };
    }
    case actions.GET_RECENT: {
      ...
      return {
        ...state,
        recent: { ...state.events, data, pages, currentPage, loading: false },
      };
    }
    ...
    case actions.SET_CURRENT: {
      ...
      return {
        ...state,
        currentEvent: { data, id, loading: false, isExpired },
      };
    }
    case actions.SET_CURRENT_LOADING: {
      ...
      return {
        ...state,
        currentEvent: { ...state.currentEvent, loading: status },
      };
    }
