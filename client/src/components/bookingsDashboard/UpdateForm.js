...
export const UpdateForm = () => {
    ...
    const [data, setData] = useState({
        ...
        "validity": moment(new Date(state.event_startUpdate.current.validity)).format("YYYY-MM-DD"),
    })
    const [priceNum, setPriceNum] = useState(state.event_startUpdate.current.price_choices)
    const [files, setFiles] = useState([])
    const [category, setCategory] = useState(state.event_startUpdate.current.category);
            ...
            <div>
                ...
                <div className="file">
                    ...
                    <div class="info">
                        ...
                        <p>Leave blank if you dont want to replace previously uploaded images</p>
                    </div>
                </div>
            </div>
            <div>
                <div className='space'>
                    ...
                    {category.map((item, index) => {
                        return (
                            <div key={index} className='lined-up'>
                                <input
                                    type="text"
