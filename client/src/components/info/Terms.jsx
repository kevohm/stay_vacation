...
const Terms = () => {
  return (
    <section className="w-full p-5 flex flex-col space-y-5">
      <header
        style={{
...
const data = [
  {
    title: "General",
    info: [
      "In all cases, drivers must be at least a minimum age to rent or drive a car. In some cases, they must also be below a maximum age. The limit(s) can vary by Service Provider, by location and by type of car.",
